...
## Since I have decided to name all the projects based on popular food cusines or some of my favourite dishes. This READ ME helps and gives an overview of the project. 
Project categories
1. Full course meal - Compelete or bigger project with idea, use cases and multi agents or tool integeration.
2. Appetizer or Drinks - More or less a simple implementation for some concepts that I tried based on a use case to test some features. These projects are merely for my learning and development.
3. Dessert - This is me just trying some crazy ideas just for fun. LOL
